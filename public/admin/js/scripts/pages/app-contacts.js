...
$(document).ready(function () {
  ...
  $('#add-contact-item').on('click', function (e) {
    ...
    userDataTable.row.add([
      ...
      '</div>',
      '<div class="media">' +
      '<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="/admin/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>' +
