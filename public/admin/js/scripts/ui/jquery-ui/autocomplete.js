...
$(document).ready(function () {
    ...
    ************************************/
    ...
    $(".ac-remote-datasource").autocomplete({
        source: "/admin/data/jquery-ui/search.php",
        minLength: 2
    });
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function (request, response) {
            ...
            $.getJSON("/admin/data/jquery-ui/search.php", request, function (data, status, xhr) {
                cache[term] = data;
                response(data);
            });
        }
    ...
    $(".ac-multiple-remote")
        ...
        .autocomplete({
            source: function (request, response) {
                $.getJSON("/admin/data/jquery-ui/search.php", {
    ...
    // XML Data Pasing
    $.ajax({
        url: "/admin/data/jquery-ui/london.xml",
        dataType: "xml",
